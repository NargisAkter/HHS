...
//WebUI.(findTestObject('Object Repository/Self_Assignment/select_Role'))
WebUI.selectOptionByIndex(findTestObject('Object Repository/Self_Assignment/select_Role'), 1)
...
WebUI.delay(4)
WebUI.selectOptionByValue(findTestObject('Object Repository/Self_Assignment/select_Patients'), 'http://hl7.org/fhir/patient/H000001237', 
    true)
...
WebUI.verifyMatch(attribute, 'userIcon BedsideNurse twSelectedDiv', true)

println(attribute)

println('BNurse self-assigned successfully')
