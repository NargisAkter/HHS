...
WebUI.selectOptionByIndex(findTestObject('Object Repository/Self_Assignment/select_Role'), 4)
...
WebUI.verifyMatch(attribute, 'userIcon race twSelectedDiv', true)

println(attribute)

println('RaceNurse self-assigned successfully')
